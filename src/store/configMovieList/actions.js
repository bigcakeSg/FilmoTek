...
export const CONFIG_VIDEO_FORMATS_MOVIELIST = 'Config Movie List: Video format';
...
export const configVideoFormatMovieList = (data) => ({
  type: CONFIG_VIDEO_FORMATS_MOVIELIST,
  payload: data
});
